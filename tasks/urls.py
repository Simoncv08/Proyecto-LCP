...
urlpatterns = [
    ...
    path('api/estudiantes/', views.estudiantes_filtrados,
         name='estudiantes_filtrados'),
    path('estudiantes/importar/', views.importar_estudiantes,
         name='importar_estudiantes'),
    path('estudiantes/<int:estudiante_id>/eliminar/',
         views.eliminar_estudiante, name='eliminar_estudiante'),
    path('estudiantes/<int:estudiante_id>/editar/',
